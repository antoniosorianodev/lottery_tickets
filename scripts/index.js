...
function loadWinnningTicketsTable() {
    ...
    // I need to get a hold of the element with ID of winningTicketsTblBody
    ...
    function buildTableRow(tableBody, data) {
        ...
        // you could pass a -1 into insertRow, but when not given an argument, the default index value is -1
        let newRow = tableBody.insertRow();

        // you could pass a 0 into insertCell, but when not given an argument, the default index value is 0
        ...
        cell3.innerHTML = new Date(data.expires).toLocaleDateString();
